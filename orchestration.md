...
First go to the new available tab "Orchestration" in the "Campaigns" AJO menu options and click on "Create Campaign" <img width="90" alt="image" src="https://github.com/ripereir-adobe/ajo-academy/blob/main/assets/Create Campaign Button.png" />. Let's start creating the visual campaign orchestration through a workflow: 
