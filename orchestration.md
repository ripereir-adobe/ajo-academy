...
- After the start sign __ in the workflow, add the 1st activity "Build Audience" click on the "+" __ sign and select "Build Audience" __ then select the relational schema "Orders_reports" as you targeting dimension ___in the click the <img width="155" alt="image" src="https://github.com/user-attachments/assets/7c065322-7e52-437b-983b-66207e98b85f" /> button on the top right hand corner.
